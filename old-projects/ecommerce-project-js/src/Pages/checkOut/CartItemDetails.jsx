    ...
    return(
        <div className="cart-item-details"> 
            ...
            <div className="product-quantity">
                <span>
                    Quantity: 
                    {isUpdatingQuantity ? <input type='number' className='input-quantity' value={quantity} onChange={(e)=>{setQuantity(e.target.value)}} onKeyDown={(e)=>{e.key==='Enter' && updateQuantity}}/> : 
